...
create or alter task vacation_spots_update
  ...
  ) as harmonized_vacation_spots ON EREvacation_spots.city = harmonized_vacation_spots.arrival_city and vacation_spots.airport = harmonized_vacation_spots.arrival_airport
  WHEN MATCHED THEN
    UPDATE SET
    ...
    begin
      ...
      if (:options = '[]') then
        CALL SYSTEM$SEND_EMAIL(
            'email_integration',
            'cnorthcutt@finemarkbank.com', -- INSERT YOUR EMAIL HERE
